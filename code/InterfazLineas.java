...
public class InterfazLineas extends JFrame {
    ...
    public InterfazLineas() {
        ...
        title2 = new JLabel("Figuras Geometricas Compuestas: Polilineas");
        title2.setFont(f2);
        ...
        menu.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                InterfazLineas.this.setVisible(false);
            }
        });
...
//    }
    ...
    public void datosTabla() {
        ...
        String[] s = {"P1", (1 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s);
        String[] s2 = {"P2", (2 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s2);
        String[] s3 = {"P3", (2 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s3);
        String[] s4 = {"P4", (3 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s4);
        String[] s5 = {"P5", (3 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s5);
        String[] s6 = {"P6", (3 * 2) + "", (3 * 2) + "", "", ""};
        tm.addRow(s6);
        String[] s7 = {"P7", (4 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s7);
        String[] s8 = {"P8", (4 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s8);
        String[] s9 = {"P9", (5 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s9);
        String[] s10 = {"P10", (4 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s10);
        String[] s11 = {"P11", (3 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s11);
        String[] s12 = {"P12", (2 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s12);
        String[] s13 = {"P13", (3 * 2) + "", (3 * 2) + "", "", ""};
        tm.addRow(s13);
        String[] s14 = {"P14", (2 * 2) + "", (2 * 2) + "", "", ""};
        tm.addRow(s14);
        String[] s15 = {"P15", (1 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s15);
        String[] s16 = {"P16", (2 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s16);
        String[] s17 = {"P17", (3 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s17);
        String[] s18 = {"P18", (4 * 2) + "", (1 * 2) + "", "", ""};
        tm.addRow(s18);

        for (int i = 0; i < tm.getRowCount(); i++) {
            int x = 30 + Integer.parseInt((String) tm.getValueAt(i, 1)) * 20;
            int y = 30 + Integer.parseInt((String) tm.getValueAt(i, 2)) * 20;
            tm.setValueAt(x + "", i, 3);
            tm.setValueAt(y + "", i, 4);
        }
        //Polares
