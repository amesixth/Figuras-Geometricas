...
public class InterfazLinVer extends JFrame {

    JPanel pp, header, pi, pd, pt;
    JLabel minX, minY, maxX, maxY, color, title1, title2;
    ...
    public InterfazLinVer() {
        super("Línea Vertical");
        pp = new JPanel();
        pi = new JPanel();
        pd = new JPanel();
        pt = new JPanel();
        ...
        title2 = new JLabel("Figuras Geometricas Simples: Línea Vertical");
        title2.setFont(f2);
        ...
        menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                InterfazLinVer.this.setVisible(false);
            }
        });
