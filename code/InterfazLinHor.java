...
public class InterfazLinHor extends JFrame {
    ...
    public InterfazLinHor() {
        ...
        title2 = new JLabel("Figuras Geometricas Simples: Línea Horizontal");
        title2.setFont(f2);
        ...
        menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                InterfazLinHor.this.setVisible(false);
            }
        });
